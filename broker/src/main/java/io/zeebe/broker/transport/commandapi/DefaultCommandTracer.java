...
public class DefaultCommandTracer implements CommandTracer {
  ...
  public void start(
    ...
    spans.put(new Id(streamId, requestId), builder.start());
  }

  @Override
  public void finish(final int streamId, final long requestId, final boolean failed) {
    final var span = spans.get(new Id(streamId, requestId));
    ...
    if (span != null) {
      ...
      Loggers.TRANSPORT_LOGGER.debug(
          "No such span for stream {} and request {}", streamId, requestId);
    }
  }
  ...
  private static final class Id {
    ...
    private Id(final int streamId, final long requestId) {
    ...
    public boolean equals(final Object other) {
      ...
      return streamId == id.streamId && requestId == id.requestId;
    }
  }
}
