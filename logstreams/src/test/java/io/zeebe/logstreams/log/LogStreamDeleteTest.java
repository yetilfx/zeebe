...
public class LogStreamDeleteTest {
  ...
  private final LogStreamRule logStreamRule = LogStreamRule.createStopped(logStorageRule);
  ...
  public void setUp() throws IOException {
    ...
    logStorageRule.open(b -> b.withMaxSegmentSize(segmentSize).withMaxEntrySize(entrySize));
    final LogStream logStream = logStreamRule.start();
    logStorageRule.setPositionListener(logStreamRule.getLogStream()::setCommitPosition);
