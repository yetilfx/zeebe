...
public class DefaultLogReplicationRequestHandlerTest {
  ...
  //  private static final LogStreamRule LOG_STREAM_RULE = LogStreamRule.createStarted(LOG_FOLDER);
  ...
  //    final LogReplicationRequest request = new DefaultLogReplicationRequest(-1,
  // events.lastPosition);
  //    final DefaultLogReplicationRequestHandler handler =
  //        new DefaultLogReplicationRequestHandler(LOG_STREAM_RULE.getLogStream());
  //
