...
public class RestoreControllerTest {
  ...
  //    final File receiverSnapshotsDirectory =
  // temporaryFolderClient.newFolder("snapshots-receiver");
  //
  ...
  //        restoreClient, nodeProvider, logReplicator, snapshotReplicator, restoreThreadContext,
  // log);
  //  }
  //
  //  @Test
  ...
  //    final long snapshotPosition = writerServer.writeEvents(numEventsInSnapshotAfterBackup,
  // EVENT);
  //    replicatorSnapshotController.takeSnapshot(snapshotPosition);
  //    snapshotRestoreContext.setPositionSupplier(
  //        () -> new Tuple<>(snapshotPosition, snapshotPosition));
  ...
  //
  //    snapshotRestoreContext.setPositionSupplier(() -> new Tuple<>(exporterPosition,
  // backupPosition));
  //
  //    // when
  ...
  //    final long backupPosition = writerServer.writeEvents(numEventsNotExported, EVENT);
  //    replicatorSnapshotController.takeSnapshot(backupPosition);
  //    snapshotRestoreContext.setPositionSupplier(() -> new Tuple<>(Long.MAX_VALUE,
  // backupPosition));
  //
  //    // when
  //    restoreController.restore(-1, backupPosition);
  ...
  //    final long snapshotPosition = writerServer.writeEvents(numEventsNotExportedAfterBackup,
  // EVENT);
  //    replicatorSnapshotController.takeSnapshot(snapshotPosition);
  //    snapshotRestoreContext.setPositionSupplier(
